    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('username_en', models.CharField(max_length=150, unique=True, validators=[django.contrib.auth.validators.UnicodeUsernameValidator()], verbose_name='username(english)')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name_en', models.CharField(max_length=150, unique=True, verbose_name='name_en')),
                ('comment', models.CharField(blank=True, default='', max_length=250, verbose_name='comment')),
                ('status', models.IntegerField(choices=[(0, '有効'), (10, 'ユーザより廃止'), (11, '運営委員より廃止'), (12, '審査落ち')], default=0, verbose_name='ステータス')),
