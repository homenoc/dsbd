...
class Connection(models.Model):
    ...
    ipv4_route_comment = models.CharField("IPv4 Routeコメント", default="", blank=True, max_length=255)
    ipv6_route = models.CharField("IPv6 Route", default=ROUTE_FULL_ROUTE, choices=ROUTE_CHOICES, max_length=255)
    ipv6_route_comment = models.CharField("IPv6 Routeコメント", default="", blank=True, max_length=255)
