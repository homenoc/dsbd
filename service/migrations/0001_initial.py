    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('service_type', models.IntegerField(choices=[('2000', 'L2'), ('3S00', 'L3 Static'), ('3B00', 'L3 BGP'), ('IP3B', 'トランジット提供'), ('CL20', 'コロケーションサービス(L2)'), ('CL3S', 'コロケーションサービス(L3 Static)'), ('CL3B', 'コロケーションサービス(L3 BGP)'), ('ET00', 'その他')], default='CL3B', verbose_name='サービスタイプ')),
                ...
                ('group', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='ServiceGroup', to='custom_auth.group')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(default=django.utils.timezone.now, verbose_name='作成日')),
                ('updated_at', models.DateTimeField(default=django.utils.timezone.now, verbose_name='更新日')),
                ('connection_type', models.IntegerField(choices=[('EIP', 'EtherIP Tunnel'), ('GRE', 'GRE Tunnel'), ('IPT', 'IPT Tunnel'), ('CC0', 'Cross Connect'), ('ETC', 'ETC')], default='EIP', verbose_name='サービスタイプ')),
                ...
                ('ipv4_route', models.CharField(choices=[('full_route', 'Full Route'), ('default_route', 'Default Route'), ('full_route', 'Etc')], default='full_route', max_length=255, verbose_name='IPv4 Route')),
                ('ipv4_comment', models.CharField(blank=True, default='', max_length=255, verbose_name='IPv4コメント')),
                ('ipv6_route', models.CharField(choices=[('full_route', 'Full Route'), ('default_route', 'Default Route'), ('full_route', 'Etc')], default='full_route', max_length=255, verbose_name='IPv6 Route')),
                ...
                ('user_comment', dsbd.models.MediumTextField(blank=True, default='', verbose_name='ユーザコメント')),
                ('admin_comment', dsbd.models.MediumTextField(blank=True, default='', verbose_name='管理者コメント')),
                ('tunnel_ip', models.ForeignKey(max_length=255, on_delete=django.db.models.deletion.CASCADE, related_name='ConnectionTunnelIP', to='router.tunnelip')),
                ('service', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='ConnectionService', to='service.service')),
            ],
            options={
